...
OBJ_ASM_FILE = build/arch/x86/boot/boot.o
OBJ_C_FILE = build/arch/x86/boot/kernel_main.o \
			 build/arch/x86/boot/console.o \
			 build/arch/x86/boot/multiboot2_header.o \
			 build/arch/x86/boot/vmm.o \
			 build/arch/x86/boot/pmm.o \
			 build/arch/x86/boot/pci.o \
			 build/libc/stdio.o
...
$(BUILD_FOLDER)/kernel.bin: $(OBJ_ASM_FILE) $(OBJ_C_FILE) linker.ld
	echo $(OBJ_ASM_FILE)
	$(LD) -n -o $(BUILD_FOLDER)/kernel.bin -T linker.ld $(OBJ_ASM_FILE) $(OBJ_C_FILE)
